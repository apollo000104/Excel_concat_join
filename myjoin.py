...
join_df = pd.concat([final_df, new_df_common_columns.reindex(final_df.columns, axis=1)], axis=0)
## Save into "out.xlsx" file
join_df.to_excel("final11.xlsx", index= False)
print(join_df)
